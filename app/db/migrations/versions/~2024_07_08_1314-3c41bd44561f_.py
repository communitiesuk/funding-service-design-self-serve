...
def upgrade():
    ...
    sa.Column('source_template_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['criteria_id'], ['criteria.criteria_id'], name=op.f('fk_subcriteria_criteria_id_criteria')),
    ...
    sa.Column('source_template_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['subcriteria_id'], ['subcriteria.subcriteria_id'], name=op.f('fk_theme_subcriteria_id_subcriteria')),
